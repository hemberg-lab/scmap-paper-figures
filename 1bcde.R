...
second_row <- plot_grid(p_1b, p_1c, p_1d, p_1e, ncol = 2, labels = c("b", "c", "d", "e"), label_size = 20)
plot_grid(plot_grid(NULL, nrow = 1, labels = c("a"), label_size = 20), second_row, nrow = 2, label_size = 20, rel_heights = c(1, 1.5))
ggsave("pdf/1bcde.pdf", w = 10, h = 15)
ggsave("jpeg/1bcde.jpeg", w = 10, h = 15)
